...
var DefaultURL = "https://api-service-catalog-management-v3-0-0.mybluemix.net/tmf-api/serviceCatalogManagement/v3";
var schema;
var hostname;
var port;
var APIRelativeAddress;
var statusCode;
const exampleEndPoint = "/serviceCatalog";
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout
});

console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF633 Service Catalog\n");
getURL();
...
function exportEnvironment(){
    ...
    envJson.values.forEach(element => {
        ...
        if (element.key == "Service_CatalogAPI"){
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF633-Service_Catalog-R18.5.postman_collection.json'),
